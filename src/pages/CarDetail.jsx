          ...
          <div className='text-gray-300'>
            <div className='md:flex md:justify-center'>
              <p className='mb-4 md:mr-8'>
                <span className='text-cyan-400 font-racing'>Make:</span> {car.make}
              </p>
              <p className='mb-4 md:mr-8'>
                <span className='text-cyan-400 font-racing'>Model:</span> {car.model}
              </p>
              <p className='mb-4 md:mr-8'>
                <span className='text-cyan-400 font-racing'>Year:</span> {car.year}
              </p>
              <p className='mb-4 md:mr-8'>
                <span className='text-cyan-400 font-racing'>Price:</span> {car.price}
              </p>
              <p className='mb-4 md:mr-8'>
                <span className='text-cyan-400 font-racing'>Mileage:</span> {car.mileage}
              </p>
            </div>
            <p className='mb-4'>
            <span className='text-cyan-400 font-racing'>Description:</span>
              <span className='text-gray-300 px-2'> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin id felis non metus consequat dapibus. Integer varius felis nec eros fermentum, vel aliquam dolor hendrerit. Sed euismod orci ut metus auctor, at aliquam felis aliquam.</span>
            </p>
          </div>
        </div>
