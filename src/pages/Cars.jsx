          ...
          {carsData.map((car) => (
            ...
            >
              <div className="relative rounded-b-sm">
                <img
                  src={car.image || (car.images && car.images[0]) || 'placeholder-image-url.jpg'} // Manejo seguro
              ...
              <div className="bg-slate-800 rounded-b-lg">
                ...
                <div className="flex justify-between items-center text-gray-200">
                  <p className="text-white mb-6 ml-6 font-bold">Year: {car.year}</p>
                  <Link
                    to={`/car/${car.id}`}
                  ...
                  <p
                    ...
                    style={{
                      textShadow: '0 0 10px rgba(0, 0, 0, 0.2), 0 0 20px rgba(0, 0, 0, 0.2)',
