  ...
  useEffect(() => {
    const handleScroll = (e) => {
      ...
      if (e.type === "wheel" || e.type === "scroll") {
        ...
        if (scrollTop > 0 && currentPosition > position) {
          // Scrolling down
          setVisible(false);
        } else if (scrollTop < 0 && currentPosition < position) {
          // Scrolling up
          setVisible(true);
        }
  ...
  return (
    <header
      ...
      style={{
        ...
        transition: 'top 0.6s ease', // Ajusta el tiempo y la suavidad de la transición aquí
        top: visible ? '0' : '-80px', // Ajusta la altura según el tamaño del header
      }}
    >
