...
import './Navbar.css'; // Asegúrate de incluir este archivo CSS
...
const Navbar = () => {
  ...
  return (
    <header
      ref={ref}
      className={`fixed w-full z-50 border-b border-gray-700/50 py-2 transition-transform duration-300 ${navbarHidden ? 'navbar-hidden' : 'navbar-visible'}`}
      style={{
