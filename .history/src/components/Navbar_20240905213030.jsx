...
const Navbar = () => {
  ...
  // Manejar el scroll para ocultar o mostrar el navbar
  const handleScroll = () => {
  ...
  return (
    <nav
      ref={navRef}
      className={`container flex justify-between items-center relative z-50 transition-transform duration-300 ${
